    ...
    return Container(
      ...
      child: Column(
        ...
        children: const [
          ...
          // 🔹 Texto descriptivo
          Text(
            'Es una Ciudad que se viste de moda, destacándose por el diseño y producción de calzado, marroquinería, confecciones, joyería, artesanías, entre otras. Cuenta con diferentes talleres, fábricas y tiendas y el primer distrito del calzado del país, con más de 214 almacenes en el sector de San Francisco.',
            style: TextStyle(
